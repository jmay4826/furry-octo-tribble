...
<p>Penpals.now.sh ("us", "we", or "our") operates the penpals.now.sh website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use
    our Service and the choices you have associated with that data. Our Privacy Policy for penpals.now.sh is managed
    through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy</a>.</p>
...
<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
    ...
    Privacy Policy have the same meanings as in our Terms and Conditions, accessible from penpals.now.sh</p>
...
<p>Penpals.now.sh uses the collected data for various purposes:</p>
<ul>
...
<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
    that transfer.</p>
<p>Penpals.now.sh will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
...
<p>Penpals.now.sh may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Penpals.now.sh</li>
...
<ul>
    <li>By email: SAMPLEEMAIL@SAMPLE.COM</li>
